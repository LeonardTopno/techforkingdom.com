				...
				<div class="row footer_bg">						
					<div class="col-lg-3 col-sm-6 col-xs-12">
						<div class="footer_logo">
							...
							<p>Building Digital Solutions for Ministries, Schools & Christian Organizations</p>
						</div>
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="footer_copyright">
							<p>&copy; 2026. All Rights Reserved by Technology For Kingdom<a href="https://techforkingdom.com/" target="_blank"> </a></p>
              <p><a href="https://migids.com" target="_blank">A mission-focussed unit of Migids Software</a></p>
						</div>
					</div>
				</div>				
			</div><!--- END CONTAINER -->
